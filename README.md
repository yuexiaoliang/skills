...
A personal collection of AI skills. A skill is a packaged set of instructions, scripts, and reference materials that extends an AI assistant's capabilities on demand without polluting the main context.

## Skills

| Skill | Trigger |
| --- | --- |
| **hono** | Building cross-runtime web APIs with Hono (Cloudflare Workers, Deno, Bun, Node.js). Covers routing, middleware, JSX, RPC client, and Zod validation. |
